...
impl ExportedClass {
    ...
    pub fn no_args_returning() -> i32 { 42 }
    pub fn one_arg_returning(_a: i32) -> i32 { 42 }
    pub fn two_args_returning(_a: i32, _b: i32) -> i32 { 42 }

    pub fn self_no_args(&self) {}
    pub fn self_one_arg(&self, _a: i32) {}
    pub fn self_two_args(&self, _a: i32, _b: i32) {}

    pub fn self_no_args_returning(&self) -> i32 { 42 }
    pub fn self_one_arg_returning(&self, _a: i32) -> i32 { 42 }
    pub fn self_two_args_returning(&self, _a: i32, _b: i32) -> i32 { 42 }

    pub fn mut_self_no_args(&mut self) {}
    pub fn mut_self_one_arg(&mut self, _a: i32) {}
    pub fn mut_self_two_args(&mut self, _a: i32, _b: i32) {}

    pub fn mut_self_no_args_returning(&mut self) -> i32 { 42 }
    pub fn mut_self_one_arg_returning(&mut self, _a: i32) -> i32 { 42 }
    pub fn mut_self_two_args_returning(&mut self, _a: i32, _b: i32) -> i32 { 42 }
